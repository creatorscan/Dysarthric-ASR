...
def torch_load(path, model):
    ...
    #keys=['encoder.embed.0.weight', 'feat_out.weight', 'feat_out.bias',
    #    'prob_out.weight', 'prob_out.bias', 'postnet.postnet.1.0.weight',
    #    'postnet.postnet.1.1.weight', 'postnet.postnet.1.1.bias', 'postnet.postnet.1.1.running_mean',
    #    'postnet.postnet.1.1.running_var']
    keys=['enc.embed.weight', 'dec.att.mlp_enc.weight', 'dec.att.mlp_ta.weight',
            'dec.lstm.0.cell.weight_ih', 'dec.feat_out.weight', 'dec.prob_out.weight']

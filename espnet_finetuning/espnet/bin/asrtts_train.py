...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument('--speech-text', default=False, action='store_true',
                        help='Unpaired speech and text only')
    ...
    parser.add_argument('--freeze_ctc', type=strtobool,
                        default=False,
                        help='Freeze CTC components. ')
